...
RSpec.describe 'users/show.html.erb', type: :feature do
  before(:each) do
    ...
    @user1 = User.new(Name: 'Amine', Bio: 'Full stack developer', email: 'md.amine.smahi@gmail.com',
                      password: 'admin@2020', Photo: 'photo_url', PostsCounter: 1, confirmed_at: Time.now)
    @user2 = User.new(Name: 'Dammy', Bio: 'Full stack developer', email: 'dammy@ymail.com', password: 'admin@2040',
                      Photo: 'photo_url', PostsCounter: 1, confirmed_at: Time.now)
    @user1.save
    @user2.save
  ...
  it 'checks content of clicked page' do
    @user3 = User.create(Name: 'Karim', Bio: 'Full stack developer', email: 'kar@ymail.com', password: 'admin@2040',
                         Photo: 'photo_url', PostsCounter: 0, confirmed_at: Time.now)
    visit users_path
